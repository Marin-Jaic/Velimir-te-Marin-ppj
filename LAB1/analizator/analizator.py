...
akcije = []
akcije += [Akcija("S_pocetno", "\\t|\\_", "", False, None, 0, Automat({"4": {"\t": [5]}, "2": {"$": [4]}, "5": {"$": [3]}, "0": {"$": [2, 6]}, "3": {"$": [1]}, "8": {" ": [9]}, "6": {"$": [8]}, "9": {"$": [7]}, "7": {"$": [1]}}), 0, 1)]
akcije += [Akcija("S_pocetno", "\\n", "", True, None, 0, Automat({"2": {"\n": [3]}, "0": {"$": [2]}, "3": {"$": [1]}}), 0, 1)]
akcije += [Akcija("S_pocetno", "#\\|", "", False, "S_komentar", 0, Automat({"2": {"#": [3]}, "0": {"$": [2]}, "4": {"|": [5]}, "3": {"$": [4]}, "5": {"$": [1]}}), 0, 1)]
akcije += [Akcija("S_komentar", "\\|#", "", False, "S_pocetno", 0, Automat({"2": {"|": [3]}, "0": {"$": [2]}, "4": {"#": [5]}, "3": {"$": [4]}, "5": {"$": [1]}}), 0, 1)]
akcije += [Akcija("S_komentar", "\\n", "", True, None, 0, Automat({"2": {"\n": [3]}, "0": {"$": [2]}, "3": {"$": [1]}}), 0, 1)]
...
akcije += [Akcija("S_unarni", "\\t|\\_", "", False, None, 0, Automat({"4": {"\t": [5]}, "2": {"$": [4]}, "5": {"$": [3]}, "0": {"$": [2, 6]}, "3": {"$": [1]}, "8": {" ": [9]}, "6": {"$": [8]}, "9": {"$": [7]}, "7": {"$": [1]}}), 0, 1)]
akcije += [Akcija("S_unarni", "\\n", "", True, None, 0, Automat({"2": {"\n": [3]}, "0": {"$": [2]}, "3": {"$": [1]}}), 0, 1)]
akcije += [Akcija("S_unarni", "-", "UMINUS", False, "S_pocetno", 0, Automat({"2": {"-": [3]}, "0": {"$": [2]}, "3": {"$": [1]}}), 0, 1)]
